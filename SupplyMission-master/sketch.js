...
var packageBody,ground,boxrect1,boxrect2,boxrect3
...
function setup() {
	...
	boxrect1 =createSprite(400,655,100,10);
	boxrect1.shapeColor='red'
	boxrect2 =createSprite(350,630,10,60);
	boxrect2.shapeColor='red'
	boxrect3 =createSprite(450,630,10,60);
